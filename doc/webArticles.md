[Path tracing Wikipedia article](https://en.wikipedia.org/wiki/Path_tracing)

[Monte Carlo method Wikipedia article](https://en.wikipedia.org/wiki/Monte_Carlo_method)
